...
class TestAttendance(EssClientTestCase):
    ...
    def test_manual_attendance_creates_record(self):
        ...
        date/check_in/check_out mirror what AttendanceManualEntryScreen.tsx
        actually sends: a separate date and HH:MM wall-clock times, converted
        server-side via wall_clock_to_utc() using the X-Timezone header.
        """
