...
class HrLoan(models.Model):
    ...
    def _ensure_default_config(self):
        """
        Create a default loan config for the main company only if one doesn't already exist.
    ...
    def _format_loan_record(self, loan):
        ...
        return {
            ...
            'approved_date': utc_to_date_string(loan.approved_date),
            'request_date': utc_to_date_string(loan.request_date),
        }
    ...
    def _format_installment(self, inst):
        ...
        return {
            ...
            'date': utc_to_date_string(inst.date),
            'amount': inst.amount,
            'paid': inst.paid,
        }
