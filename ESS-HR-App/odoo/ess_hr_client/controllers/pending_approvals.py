...
def _gather_pending(req, approver_employee_id):
    ...
    for l in leaves:
        result.append({
            ...
            'description': '%s — %s to %s' % (
                ...
                utc_to_date_string(l.date_from) or '',
                utc_to_date_string(l.date_to) or '',
            ),
            'request_date': utc_to_date_string(l.date_from),
            'state': l.state,
        })
    ...
    for l in loans:
        result.append({
            ...
            'request_date': utc_to_date_string(l.request_date),
            'state': l.state,
        })
    ...
    for a in advances:
        result.append({
            ...
            'request_date': utc_to_date_string(a.request_date),
            'state': a.state,
        })
    ...
    for lt in letters:
        result.append({
            ...
            'request_date': utc_to_date_string(lt.request_date),
            'state': lt.state,
        })
    ...
    for d in docs:
        result.append({
            ...
            'request_date': utc_to_date_string(d.request_date),
            'state': d.state,
        })
    ...
    for c in certs:
        result.append({
            ...
            'description': c.name,
            'request_date': utc_to_date_string(c.request_date),
            'state': c.state,
        })
    ...
    for s in services:
        result.append({
            ...
            'request_date': utc_to_date_string(s.request_date),
            'state': s.state,
        })
