...
#         return call_and_log(
#             '/ess/api/payslip/<id>',
#             lambda: request.env['hr.payslip'].sudo().get_payslip_detail(payslip_id, employee_id),
#         )
#
...
#         return call_and_log(
#             '/ess/api/payslip/pdf',
#             lambda: request.env['hr.payslip'].sudo().get_payslip_pdf(kw.get('payslip_id'), employee_id),
#         )
