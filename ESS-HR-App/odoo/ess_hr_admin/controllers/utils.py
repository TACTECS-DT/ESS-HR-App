...
from ..tz_utils import validate_timezone_header

_logger = logging.getLogger(__name__)
_ADMIN_API_KEY_PARAM = 'ess.admin.mobile.key'
...
def call_admin(endpoint: str, fn, *, server_url: str = None) -> http.Response:
    ...
    try:
        validate_timezone_header(request.httprequest.headers.get('X-Timezone'))
        result = fn()
