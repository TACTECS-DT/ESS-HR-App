...
export default function HomeScreen() {
  ...
  const {data: attendanceSummary, refetch: refetchAttendance} = useQuery({
  ...
  // Sync with physical terminal check-ins: refetch whenever Home tab gains focus
  useFocusEffect(
    useCallback(() => {
      refetchAttendance();
    }, [refetchAttendance]),
  ...
  async function onRefresh() {
    setRefreshing(true);
    await Promise.all([refetchBalances(), refetchNotifications(), refetchProfile(), refetchAttendance()]);
    setRefreshing(false);
  }
