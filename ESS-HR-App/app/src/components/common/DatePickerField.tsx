...
import {parseApiDateTime} from '../../utils/timezone';
...
function toDate(s: string): Date {
  // parseApiDateTime constructs date-only 'YYYY-MM-DD' strings via the
  // local Date(y, m, d) form — new Date(s) directly would parse as UTC
  // midnight, showing the wrong default day in the picker for users west
  // of UTC.
  return parseApiDateTime(s) ?? new Date();
}
